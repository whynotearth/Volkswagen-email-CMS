  ...
  <footer class="page-footer h-12 relative">
    ...
    <div class="container flex items-center h-full z-2 relative">
      <a
        ...
        class="link-back block bg-surface flex h-full items-center justify-start px-6 font-semibold text-error cursor-pointer select-none"
      >
      ...
      <a
        @click="$emit('changeStep', 1)"
        class="link-forward block bg-primary flex-grow text-white flex h-full items-center justify-end px-6 font-semibold cursor-pointer select-none"
      >
